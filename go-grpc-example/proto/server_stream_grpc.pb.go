...
type StreamServerClient interface {
	...
	ListValue(ctx context.Context, in *SimpleReq, opts ...grpc.CallOption) (StreamServer_ListValueClient, error)
}
...
func (c *streamServerClient) ListValue(ctx context.Context, in *SimpleReq, opts ...grpc.CallOption) (StreamServer_ListValueClient, error) {
...
func (x *streamServerListValueClient) Recv() (*StreamResp, error) {
	m := new(StreamResp)
...
type StreamServerServer interface {
	// 服务端流式rpc，在响应数据前添加stream
	ListValue(*SimpleReq, StreamServer_ListValueServer) error
...
func (UnimplementedStreamServerServer) ListValue(*SimpleReq, StreamServer_ListValueServer) error {
...
func (x *streamServerListValueServer) Send(m *StreamResp) error {
