...
func (consulClient *KitDiscoverClient) Register(serviceName, instanceId, healthCheckUrl string, instanceHost string, instancePort int, meta map[string]string) error {
...
func (consulClient *KitDiscoverClient) DiscoverServices(serviceName string) ([]interface{},error) {
	...
	if ok {
		return instanceList.([]interface{}),nil
	}
	// 申请锁
