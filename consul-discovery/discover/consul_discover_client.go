...
func (consulClient *ConsulDiscoverClient) Register(serviceName, instanceId, healthCheckUrl string,instanceHost string, instancePort int, meta map[string]string) error {
	...
	if err == nil {
		...
		if err == nil {
			...
			if resp.StatusCode == 200 {
				...
				return errors.New("Register Service Error!")
			}
		}
	}
	return err
...
func (consulClient *ConsulDiscoverClient) DeRegister(instanceId string) error {
	...
	if err==nil{
		...
		if resp.StatusCode == 200 {
			...
			return errors.New("Deregister Service Error!")
		}
	}
	return err
}
